...
GPIO::PORTA.salida(5);
GPIO::PORTA.salida(6).cfg_mode(GPIO::Mode::Alternate).cfg_alternate(GPIO::AlternFunct::AF5); //TIM16 output compare?
...
GPIO::PORTC.salida(6); //OJOOOOO arriba el correcto es PC4
